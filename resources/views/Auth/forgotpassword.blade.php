                        ...
                        <tbody>
                           <tr>
                              <td style="background-color:#f7f7f7; text-align:justify; font:normal 15px Arial, Helvetica, sans-serif;line-height:18px; padding:20px 25px 20px 25px;" valign="top">
                               Hi, <br/> <br/> Please click on below link to reset your PULSE account password.
                              </td>
                           </tr>
                        </tbody>
                     </table>
                     ...
                     <table class="main" cellpadding="0" cellspacing="0" border="0" width="600">
                        <tbody>
                           <tr>
                              ...
                              <a href="{{ url('/') }}/deeplink_resetpassword?userid=<?=$userid?>" class="CSS3_Button" id="Theme-a" style="padding:10px 20px; background:#2C3B63; color:#fff;">Reset Password</a>
                              </td>
                           </tr>
                           <tr>
